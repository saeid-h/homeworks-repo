...
if n == 2:
      # Q2d:
      Q2d2 = PSO(n=n, swarmSize=200, myPRNG=myPRNG, show=10)
      ...
      #print ("\n\nStart calculation for 200D ...")
      maxPos = 1000
      minPos = -1000
      goOn = True
      itr = 0;
      while goOn:
            Q2d200 = PSO(n=n, swarmSize=100, myPRNG=myPRNG, Vmax=1, \
                         PhiC=2, PhiS=1, inertia=1,\
                        maxPos=maxPos, minPos=minPos,
                        minIteration = 1000, tol = 0.01, show=0)
            maxPos = max(Q2d200['gBest'])
            minPos = min(Q2d200['gBest'])
            print (minPos, maxPos)
            itr += 1
            if Q2d200['gBestVal'] < .01 or itr > 1000:
                  goOn = False
            
            
      print ("\n\nResults for question 2 part d - 200D: ")
      print ("Best Global Position: ", Q2d200['gBest'])
      print ("Best Global Value: ", Q2d200['gBestVal'])
      print ("Number of Best Values: ", len(Q2d200['gBestValList']))
