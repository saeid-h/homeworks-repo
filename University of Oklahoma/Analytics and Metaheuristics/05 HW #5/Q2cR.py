...
def localBest (pBestVal2,i):          #Calculate the local best
      ...
      if pBestVal2[prev] == min(pBestVal2[prev],pBestVal2[curr],pBestVal2[nxt]):
            lBesti = prev
      if pBestVal2[curr] == min(pBestVal2[prev],pBestVal2[curr],pBestVal2[nxt]):
            lBesti = curr      
      if pBestVal2[nxt] == min(pBestVal2[prev],pBestVal2[curr],pBestVal2[nxt]):
            lBesti = nxt            
      return lBesti
