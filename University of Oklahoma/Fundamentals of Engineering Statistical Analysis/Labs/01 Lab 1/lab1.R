...
mean(ddt$LENGTH)
sd(ddt$WEIGHT)
plot(ddt$WEIGHT, ddt$LENGTH, col="red")
plot(ddt$LENGTH,ddt$WEIGHT,  col="red")
...
boxplot(WEIGHT~DDT,col="Red",data=ddt) 
...
with(ddt,boxplot(DDT,ylab="RIVER",col="Red",notch=TRUE))
